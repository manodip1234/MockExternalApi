...
public sealed class FoodApiController : ControllerBase
{
    ...
    [
        new() { service_name = "Ration Card Issuance", department_name = "Food and Supplies Department", stipulated_days = 30, stipulated_hours = 0, stipulated_text = "Standard processing", resolution_days = 30, resolution_hours = 0, appeal_days = 30, appeal_hours = 0, reappeal_days = 60, reappeal_hours = 0, jurisdiction_mode = "LGD", jurisdiction_groups = [ new() { group_name = "State Wide", jurisdiction = [ new() { state_name = "West Bengal" } ] } ], is_active = true, beyond_department_days = 7, has_external_dependency = true },
        new() { service_name = "Ration Card Modification", department_name = "Food and Supplies Department", stipulated_days = 15, stipulated_hours = 0, stipulated_text = "Standard processing", resolution_days = 15, resolution_hours = 0, appeal_days = 30, appeal_hours = 0, reappeal_days = 60, reappeal_hours = 0, jurisdiction_mode = "LGD", jurisdiction_groups = [ new() { group_name = "State Wide", jurisdiction = [ new() { state_name = "West Bengal" } ] } ], is_active = true, beyond_department_days = null, has_external_dependency = false },
    ];
