...
public sealed class TransApiController : ControllerBase
{
    ...
    [
        new() { service_name = "Birth Certificate Issuance", department_name = "Health & Family Welfare Department", stipulated_days = 7, stipulated_hours = 0, stipulated_text = "7 working days", resolution_days = 7, resolution_hours = 0, appeal_days = 30, appeal_hours = 0, reappeal_days = 60, reappeal_hours = 0, jurisdiction_mode = "LGD", jurisdiction_scope = "SERVICE", jurisdiction_groups = [ new() { group_name = "State Wide", jurisdiction = [ new() { state_name = "West Bengal" } ] } ], is_active = true, beyond_department_days = 2, has_external_dependency = true },
        new() { service_name = "Death Certificate Issuance", department_name = "Health & Family Welfare Department", stipulated_days = 7, stipulated_hours = 0, stipulated_text = "7 working days", resolution_days = 7, resolution_hours = 0, appeal_days = 30, appeal_hours = 0, reappeal_days = 60, reappeal_hours = 0, jurisdiction_mode = "LGD", jurisdiction_scope = "SERVICE", jurisdiction_groups = [ new() { group_name = "State Wide", jurisdiction = [ new() { state_name = "West Bengal" } ] } ], is_active = true, beyond_department_days = null, has_external_dependency = false },
    ];
